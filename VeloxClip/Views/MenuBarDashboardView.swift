...
// The menu bar popover. Lived in VeloxClipApp.swift, which made the app entry
// point — the first file anyone reads to understand startup — also the home of
// the largest single View in the project.
